...
form.addEventListener("submit", async (e)=>{
    ...
    if (lastQueryValue === queryValue) return;
    else {
        clearGallery();
...
loadMoreButton.addEventListener("click", async ()=>{
    ...
    const data = await fetchImages(requestParams);
    showResult(data);
    const summaryImagesCount = (requestParams.page - 1) * requestParams.countPerPage + data.hits.length;
...
async function fetchImages(params) {
    try {
        let response = await (0, _axiosDefault.default).get("https://pixabay.com/api/", {
            params: {
        ...
        if (response.data.total === 0) throw new Error();
...
function showResult(resultData) {
    ...
    const hitsStrings = hits.map((hit)=>`
...
},{"axios":"jo6P5","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../sass/index.scss":"9OQSl"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"9OQSl":[function() {},{}]},["aRq6p","ebWYT"], "ebWYT", "parcelRequired7c6")
